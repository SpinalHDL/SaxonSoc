...
set program_file [file join ${project_base} ${project_name}.runs impl_1 QmtechK7SmpLinux.bit]
variable flash_file
...
proc cfgmem {} {
	...
	variable sbi_file
	variable boot_file
	write_cfgmem -format mcs -size 32 -interface SPIx4 -loadbit "up 0x00000000 $program_file" -loaddata "up 0x00D00000 $sbi_file up 0x00D40000 $boot_file" -force -file $flash_file
}
...
proc flash {} {
	...
	open_hw_target
	current_hw_device [get_hw_devices ${fpga_part}_0]
	create_hw_cfgmem -hw_device [lindex [get_hw_devices ${fpga_part}_0] 0] [lindex [get_cfgmem_parts {s25fl256l-spi-x1_x2_x4}] 0]
