...
set boot_file ${base}/../../../../u-boot/u-boot.bin
#set boot_file ${base}/../../../../barebox/barebox.bin
...
set sbi_file ${base}/../../../../opensbi/build/platform/spinal/saxon/bsp/firmware/fw_jump.bin
